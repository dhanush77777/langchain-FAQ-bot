...
# def similarity_search_batch(texts_batch, user_question):
#     # Divide texts_batch into smaller batches
#     batch_size = 100
#     batches = [texts_batch[i:i + batch_size] for i in range(0, len(texts_batch), batch_size)]

#     results = []

#     with concurrent.futures.ThreadPoolExecutor() as executor:
#         # Submit requests asynchronously
#         futures = [executor.submit(process_batch, batch, user_question) for batch in batches]
...
#     sys.exit(0)
#     return results
# def process_batch(batch, user_question):
#     docsearch = OpenSearchVectorSearch.from_documents(
#         batch,
#         embedding,
#         opensearch_url=opensearch_url,
#         http_auth=http_auth,
#         index_name="orders2_v3_alias",
#         use_ssl=False,
#         verify_certs=False,
#         ssl_assert_hostname=False,
#         ssl_show_warn=False,
